...
# Use monthly new cases as the time series
ts_cases = df_spain_filtered.set_index('date')['new_cases'].fillna(0)
...
plt.title('Spain - AR(10) COVID-19 Case Forecast (Next Two Years) Using Data from 2020-2022')
plt.xlabel('Date')
plt.ylabel('Daily New Cases')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('../images/prediction_cases.png', format='png', bbox_inches='tight')
